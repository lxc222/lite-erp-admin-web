...
const onSubmitCost = ({ validateResult, firstError, e }) => {
    e.preventDefault();
    if (validateResult === true) {
        let distUrl = "/api/biz/mktp/otherCost/add";
    ...
    >
        ...
        >
            <t_form_item_mkp_store_center
                label="商铺中心"
                help="*必填"
                v-model="cost_submit_data.submitData.centerId"
            ...
            <t_form_item_mkp_store_list
                ...
                :status="globalConstDef.enableModel.Enabled.toString()"
                :centerId="cost_submit_data.submitData.centerId"
            />
