...
const onSubmitEntitydata = ({ validateResult, firstError, e }) => {
    ...
    if (validateResult === true) {
        let distUrl = "/api/biz/wms/houseTag/add";
        if (entity_submit_data.value.submitData.id > 0) {
            distUrl = "/api/biz/wms/houseTag/change";
        }
...
<template>
    <t-card :bordered="true" :style="{ margin: '5px' }" id="query_form">
        <div style="padding-top: 10px; padding-bottom: 10px">
            ...
            >
                <t-form-item label="标签名称" name="标签名称">
    ...
    >
        ...
        >
            <t-form-item label="标签名称" name="标签名称" help="*必填">
                <t-input placeholder="标签名称" v-model="entity_submit_data.submitData.title" />
            </t-form-item>
