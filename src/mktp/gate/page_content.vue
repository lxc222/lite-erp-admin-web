...
const onSubmitEntityData = ({ validateResult, firstError, e }) => {
    ...
    if (validateResult === true) {
        let distUrl = "/api/biz/mktp/gate/add";
        if (entity_submit_data.value.submitData.id > 0) {
            distUrl = "/api/biz/mktp/gate/change";
        }
...
<template>
    <t-card :bordered="true" :style="{ margin: '5px' }" id="query_form">
        <div style="padding-top: 10px; padding-bottom: 10px">
            ...
            >
                <t-form-item label="门岗名称" name="门岗名称">
    ...
    >
        ...
        >
            <t-form-item label="门岗名称" name="门岗名称" help="*必填">
                <t-input placeholder="门岗名称" v-model="entity_submit_data.submitData.title" />
            </t-form-item>
